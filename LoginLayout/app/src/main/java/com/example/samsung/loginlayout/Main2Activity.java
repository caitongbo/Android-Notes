...
public class Main2Activity extends AppCompatActivity {
    ...
    public void login(View view) {
        ...
        switch (checkInfo(username, password)) {
            case 1:
                startActivity(new Intent(Main2Activity.this, SuccessAcitvity.class));
                finish();
                break;
            case 0:
                Toast.makeText(Main2Activity.this, "未通过验证！", Toast.LENGTH_LONG).show();
                break;
            default:
        }
    }
    ...
    public void save(){
        ...
        if (remember.isChecked()){
            ...
            if ("admin".equals(name)&&"admin".equals(pass)){
                ...
                Toast.makeText(Main2Activity.this,"登陆信息有误，请重新输入",Toast.LENGTH_LONG).show();
        }
